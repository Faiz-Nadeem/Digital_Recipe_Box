...
class CategoryDescription1 extends StatelessWidget {
  final Recipe recipe;
  CategoryDescription1({Key? key, required this.recipe}) : super(key: key);
  List<int> recipeIndices = [5, 6, 7, 9, 8];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Simple Chicken Based'),
